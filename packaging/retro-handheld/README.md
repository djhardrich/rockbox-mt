...
[Dia](https://github.com/Dia2809) - libsdl2_scaler shim that was an early key piece for PortMaster (the shim has since been removed; the GLES present path now handles upscaling directly).